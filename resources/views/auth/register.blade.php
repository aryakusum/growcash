                    ...
                    <div>
                        ...
                        <div class="mt-2 text-xs text-gray-400 space-y-1">
                            <p id="hint-length" class="flex items-center">
                                <svg class="w-3 h-3 mr-1.5 opacity-0 transition-opacity" fill="currentColor" viewBox="0 0 20 20"><path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd"/></svg>
                                Min. 8 characters
                            </p>
